...
summary: Sometimes all you need is a quick way to locally watch and compile your SCSS styles. If you're already using Node.js and NPM for your local environment, then using NPM scripts is one of the best ways to get a minimal setup up and running.
date: 2015-07-17
published: true
archive: true
...
import npmRunWatchCssImgUrl from "./images/npm-run-watch-css.png";
import npmImgUrl from "./images/npm.png";
import puppiesGif from "./images/puppies.gif";
import terminalImgUrl from "./images/terminal-with-3-windows.png";
import fileStructureImgUrl from "./images/file-structure.png";
