...
setup: |
  ...
  import itermImg from './terminal-with-3-windows.png'
  import fileStructureImg from './file-structure.png'
  import newTerminalImg from './npm-run-watch-css.png'
  import puppiesImg from './puppies.gif'
