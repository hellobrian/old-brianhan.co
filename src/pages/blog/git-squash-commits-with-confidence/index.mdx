...
summary: "Here are some tips that I've learned to get more comfortable squashing and rebasing in git."
date: 2019-01-11
published: true
archive: true
...
import imgSrc from "./images/johnny-brown-vaporwavey-raindrop.jpeg";

<img src={imgSrc} alt="Photo by Johnny Brown of a crazy raindrop" />

<small style="font-family: Karla, sans-serif;">
  Photo by Johnny Brown on
  [Unsplash](https://unsplash.com/photos/V-afy242gY4){" "}
</small>
