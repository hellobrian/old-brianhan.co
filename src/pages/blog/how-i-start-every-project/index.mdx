...
summary: A quick guide to starting new frontend projects
date: 2018-12-25
archive: true
published: true
...
import imgSrc from "./images/macbook-sunrise.jpeg";

<img
  src={imgSrc}
  alt="Photo by Jefferson Santos of a macbook with the sunrise outside"
/>
<small>
  Photo by Jefferson Santos on
  [Unsplash](https://unsplash.com/photos/V9sv7QrDUgc) (Cropped)
</small>
