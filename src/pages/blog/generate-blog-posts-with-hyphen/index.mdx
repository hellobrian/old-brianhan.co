...
summary: Scaffold arbitrary folders, files and boilerplate code with Hygen.
date: 2019-01-04
updated: 2020-05-18
archived: true
published: true
...
import imgSrc from "./images/stamp.jpeg";

<img src={imgSrc} alt="Photo of big stamp by Hannes Wolf" />

<small style="font-family: Karla, sans-serif;">
  Photo by Hannes Wolf on [Unsplash](https://unsplash.com/photos/n2ILm0aTCYo)
</small>
...
<details style="color: var(--foreground)">
  <summary>Read more about frontmatter here</summary>
```md
### Updated
