...
summary: "I failed a lot trying to use WSL to replicate the dev environment I use on my Mac. Then something weird happened: I ditched the fancy subsystem and now I'm doing dev things on my PC."
date: 2019-01-08
archive: true
published: true
...
import imgSrc from "./images/windows-image-crop.jpeg";

<img src={imgSrc} alt="Photo by Samuel Zeller" />

<small style="font-family: Karla, sans-serif;">
  Photo by Samuel Zeller on [Unsplash](https://unsplash.com/photos/IfFndn_imbU)
  (Cropped)
</small>
