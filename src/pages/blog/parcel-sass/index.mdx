...
summary: Parcel is one of the easiest ways to use SCSS in any project. This article will walk you through a few simple steps to get started.
date: 2018-12-18
archive: true
published: true
...
import imgSrc from "./images/parcel-unsplash.jpeg";

<img src={imgSrc} alt="Photo by Leone Venter on Unsplash" />
